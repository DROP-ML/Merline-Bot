...
async function v5_t2i(sock, m, M, text) {

    const randomNumber = Math.floor(Math.random() * 10) + 1;
    const outputPath = `${randomNumber}.png`;
    react(sock,m,M,lang.react.process)

    const imageUrl = 'https://aemt.me/v5/text2img?text=' + text; // Replace with your image URL
    ...
    try {
        ...
        await sendImage(sock, m, M, outputPath, "V5 T2I Image Creation")
