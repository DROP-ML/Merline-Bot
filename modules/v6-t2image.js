...
async function v6_t2i(sock, m, M, text) {

    const randomNumber = Math.floor(Math.random() * 10) + 1;
    const outputPath = `${randomNumber}.png`;
    react(sock,m,M,lang.react.process)

    const imageUrl = 'https://aemt.me/v6/text2img?text=' + text; // Replace with your image URL
    ...
    try {
        ...
        await sendImage(sock, m, M, outputPath, "V6 T2I Image Creation")
