...
async function v2_t2i(sock, m, M, text) {

    const randomNumber = Math.floor(Math.random() * 10) + 1;
    const outputPath = `${randomNumber}.png`;
    react(sock,m,M,lang.react.process)

    const imageUrl = 'https://aemt.me/v2/text2img?text=' + text; // Replace with your image URL
    ...
    try {
        ...
        await sendImage(sock, m, M, outputPath, "V2 T2I Image Creation")
